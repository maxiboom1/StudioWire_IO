...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-36 overflow-hidden rounded-md border border-studio-border bg-white p-1 text-studio-text shadow-md',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={cn(
        'z-50 min-w-44 overflow-hidden rounded-md border border-studio-border bg-white p-1 text-studio-text shadow-md',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Separator ref={ref} className={cn('-mx-1 my-1 h-px bg-studio-border', className)} {...props} />
));
